...
- r-foundations — R learning labs + visualizations
- dna-sequence-analyzer — GC content, codon usage, motif search
- multi-language-systems-toolkit — Python + C++ + Java + Bash
- portfolio-website — my professional homepage

## Current Goals 📈
- Build a clean, professional GitHub portfolio
- Refresh Python, C++, Java, and Linux fundamentals
- Learn R before Spring 2027 coursework
- Create bioinformatics-focused projects
